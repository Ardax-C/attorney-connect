...
<div class="bg-zinc-700 p-4 rounded-sm w-full h-full flex flex-col overflow-hidden hover:bg-slate-900 hover:border hover:border-yellow-700 hover:shadow-lg hover:shadow-slate-900">
